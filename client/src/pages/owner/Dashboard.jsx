...
const Dashboard = () => {
  ...
  const dashboardCards = [
    { title: 'Autos gesamt', value: data.totalCars, icon: assets.carIconColored },
    {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title
        ...
        subTitle='Behalte Fahrzeuge, Buchungen, Umsatz und aktuelle Aktivitaeten der Plattform im Blick.'
      />
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full'>
          <h1 className='text-lg font-medium'>Neueste Buchungen</h1>
          <p className='text-gray-500'>Aktuelle Kundenbuchungen</p>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs'>
          <h1 className='text-lg font-medium'>Monatsumsatz</h1>
          <p className='text-gray-500'>Umsatz im aktuellen Monat</p>
