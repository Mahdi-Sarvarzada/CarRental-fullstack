  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title
        ...
        subTitle='Behalte alle Kundenbuchungen im Blick, bestaetige oder storniere Anfragen und verwalte den Status.'
      />
        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          <thead className='text-gray-500'>
            <tr>
              ...
              <th className='p-3 font-medium max-md:hidden'>Zeitraum</th>
              <th className='p-3 font-medium'>Gesamt</th>
              <th className='p-3 font-medium max-md:hidden'>Zahlung</th>
