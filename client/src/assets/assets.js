...
export const menuLinks = [
    ...
    { name: "Autos", path: ROUTES.cars },
    { name: "Meine Buchungen", path: ROUTES.bookings },
]

export const ownerMenuLinks = [
    { name: "Uebersicht", path: ROUTES.owner, icon: dashboardIcon, coloredIcon: dashboardIconColored },
    { name: "Auto hinzufuegen", path: ROUTES.ownerAddCar, icon: addIcon, coloredIcon: addIconColored },
    { name: "Autos verwalten", path: ROUTES.ownerManageCars, icon: carIcon, coloredIcon: carIconColored },
    { name: "Buchungen verwalten", path: ROUTES.ownerManageBookings, icon: listIcon, coloredIcon: listIconColored },
]
