  ...
  return (
    ...
    >
      <div className='text-white'>
        <h2 className='text-3xl font-medium'>Du besitzt ein Luxusauto?</h2>
        <p className='mt-2'>
          Verdiene ganz unkompliziert mit deinem Fahrzeug, indem du es bei
          CarRental inserierst.
        </p>
        <p className='max-w-130'>
          Wir kuemmern uns um Versicherung, Fahrerverifizierung und sichere
          Zahlungen, damit du entspannt passives Einkommen erzielen kannst.
        </p>
