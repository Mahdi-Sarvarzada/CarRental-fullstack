...
const Newsletter = () => {
  return (
    ...
    className="flex flex-col items-center justify-center text-center space-y-2 max-md:px-4 my-10 mb-40">
            ...
            className="md:text-4xl text-2xl font-semibold">Kein Angebot mehr verpassen</motion.h1>
            ...
            className="md:text-lg text-gray-500/70 pb-8">
                Abonniere unseren Newsletter fuer neue Angebote, aktuelle Fahrzeuge und exklusive Rabatte.
            </motion.p>
            <motion.form 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
